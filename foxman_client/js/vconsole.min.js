            ...
            : function(e) {
              ...
              , x = function(e) {
                ...
                s(t, [{
                    ...
                    value: function() {
                        var e = this
                          , t = f["default"].all(".vc-subtab", e.$tabbox);
                    ...
                    value: function(e) {
                        ...
                        if (t.length || e.content) {
                            ...
                            for (var a = f["default"].render(h["default"], {
                                ...
                                try {
                                    if ("" === t[d])
                                        continue;u.isFunction(t[d]) ? v.innerHTML = " " + t[d].toString() : u.isObject(t[d]) || u.isArray(t[d]) ? v = this.getFoldedLine(t[d]) : v.innerHTML = " " + u.htmlEncode(t[d]).replace(/\n/g, "<br/>")
                                } catch (p) {
                                    v.innerHTML = " [" + c(t[d]) + "]"
                                }
                                v && s.appendChild(v)
                            ...
                            f["default"].one(".vc-log", this.$tabbox).appendChild(a),
                            ...
                            if (0 == n.children.length && e) {
                                for (var l = u.getObjAllKeys(e), r = 0; r < l.length; r++) {
                                    ...
                                    if (u.isArray(a)) {
                                        ...
                                        d = f["default"].render(y["default"], g)
                                    }
                                    n.appendChild(d)
                                }
                                if (u.isObject(e)) {
                                    var b = e.__proto__
                                      , h = void 0;
                                    h = u.isObject(b) ? o.getFoldedLine(b, f["default"].render(w["default"], {
                                        key: "__proto__",
                                        keyType: "private",
              ...
              , w = function(e) {
                function t() {
                    ...
                    for (var o = arguments.length, n = Array(o), l = 0; o > l; l++)
                        n[l] = arguments[l];
                    var a = r(this, (e = Object.getPrototypeOf(t)).call.apply(e, [this].concat(n)));
                    return a.$tabbox = d["default"].render(b["default"], {}),
                    a.$header = null ,
                    a.reqList = {},
                    a.domList = {},
                    a.isShow = !1,
                ...
                c(t, [{
                    ...
                    value: function(e, t) {
                        ...
                        a ? a.parentNode.replaceChild(r, a) : d["default"].one(".vc-log", this.$tabbox).appendChild(r),
                        this.domList[e] = r;
