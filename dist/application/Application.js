...
var Application = function (_EventEmitter) {
    ...
    function Application() {
        ...
        _this.uid = _foxmanApi.util.createSystemId();
        _this.scopeMap = {
            __ready: __ready,
    ...
    _createClass(Application, [{
        ...
        value: function complete(plugin) {
            ...
            if (result === -1) {
                _foxmanApi.util.debugLog('请检查是否在plugin中的 before.. 方法内重复调用 this.complete');
            }
        ...
        value: function setScope(scope) {
            this.scope = scope;
            this.emit(scope, new _foxmanApi.Event(scope, 'app'));
        }
    }]);
