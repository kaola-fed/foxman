        ...
        return (function(e) {
            ...
            function(e, t, o) {
                ...
                var l = o(1),
                    ...
                    f = n(v),
                    p = new i['default'](),
                    g = new s['default']('default', 'Log');
                p.addPlugin(g);
                var b = new u['default']('system', 'System');
                p.addPlugin(b);
                var h = new f['default']('network', 'Network');
                p.addPlugin(h), (p.VConsolePlugin = a['default']), (t[
                    'default'
                    ...
                    function e(e, t) {
                        for (var o = 0; o < t.length; o++) {
                            ...
                            (n.enumerable =
                                ...
                                (n.writable = !0), Object.defineProperty(
                                e,
                                n.key,
                                n
                            );
                ...
                var f = o(10),
                    ...
                    k = (function() {
                        function e() {
                            i(this, e);
                            var t = this;
                            (this.version = c['default'].version), (this.html =
                                p[
                                    'default'
                                ]), (this.$dom = null), (this.activedTab =
                                ''), (this.tabList = []), (this.pluginList = {}), (this.isReady = !1), (this.switchPos = {
                                x: 10,
                                y: 10,
                                startX: 0,
                                startY: 0,
                        ...
                        return r(e, [
                            {
                                ...
                                value: function() {
                                    ...
                                    if (!v['default'].one(e)) {
                                        ...
                                        (t.innerHTML = this.html), document.documentElement.appendChild(
                                            t.children[0]
                                        );
                                    }
                                    ...
                                    (n || l) &&
                                        (n + o.offsetWidth >
                                            ...
                                            (l =
                                                ...
                                                o.offsetHeight), 0 > n &&
                                            (n = 0), 0 > l &&
                                            (l = 0), (this.switchPos.x = n), (this.switchPos.y = l), (v[
                                            'default'
                                        ].one('.vc-switch').style.right =
                                            n + 'px'), (v['default'].one(
                                            '.vc-switch'
                                        ).style.bottom =
                                            l + 'px')), (v['default'].one(
                                        ...
                                        function(t) {
                                            if (
                                                ...
                                                c.initMouseEvent(
                                                    ...
                                                    0,
                                                    null
                                                ), (c.forwardedTouchEvent = !0), c.initEvent(
                                                    'click',
                                                    !0,
                                                    !0
                                                ), r.dispatchEvent(c);
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    ...
                                    v['default'].bind(t, 'touchstart', function(
                                        ...
                                        (e.switchPos.startX =
                                            t.touches[0].pageX), (e.switchPos.startY =
                                            t.touches[0].pageY);
                                    }), v[
                                        'default'
                                    ].bind(t, 'touchend', function(t) {
                                        (e.switchPos.x =
                                            e.switchPos.endX), (e.switchPos.y = e.switchPos.endY), (e.switchPos.startX = 0), (e.switchPos.startY = 0), (e.switchPos.endX = 0), (e.switchPos.endY = 0), d.setStorage('switch_x', e.switchPos.x), d.setStorage('switch_y', e.switchPos.y);
                                    }), v[
                                        'default'
                                    ].bind(t, 'touchmove', function(o) {
                                        if (o.touches.length > 0) {
                                            ...
                                            i + t.offsetWidth >
                                                ...
                                                i + 'px'), (t.style.bottom =
                                                r +
                                                'px'), (e.switchPos.endX = i), (e.switchPos.endY = r), o.preventDefault();
                                        }
                                    }), v['default'].bind(
                                        ...
                                        function(t) {
                                            return t.target !=
                                                v['default'].one('.vc-panel')
                                                ? !1
                                                : void (v['default'].hasClass(
                                                      e.$dom,
                                                      'vc-toggle'
                                                  ) ||
                                    ...
                                    v['default'].bind(o, 'touchstart', function(
                                        ...
                                        'default'
                                    ].bind(o, 'touchmove', function(e) {
                                        n && e.preventDefault();
                                    }), v[
                                        'default'
                                    ].bind(o, 'touchend', function(e) {
                                        n = !1;
                                    });
                                }
                            },
                                            ...
                                            (d.isString(o)
                                                ...
                                                : d.isFunction(o.appendTo)
                                                      ...
                                                      : d.isElement(o) &&
                                                            l.appendChild(
                                                                o
                                                            )), v['default'].one('.vc-content', t.$dom).appendChild(l);
                            ...
                            },
                            {
                                ...
                                value: function(e) {
                                    return void 0 !== this.pluginList[e.id]
                                        ...
                                        : ((this.pluginList[e.id] = e), this
                                              .isReady &&
                                              (this._initPlugin(e), 1 ==
                                                  this.tabList.length &&
                                                  this.showTab(
                                                      this.tabList[0]
                                                  )), !0);
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    ...
                                    v[
                                        'default'
                                    ].bind(e, 'transitionend', function(o) {
                                        (e.style.display =
                                            'none'), (t.style.display = 'none');
                                    });
                                }
                            },
                            {
            ...
            function(e, t) {
                    ...
                    function o(e) {
                        if (d(e)) {
                            ...
                            for (var b = 0; b < g.length; b++) {
                                var h = g[b];
                                (e.hasOwnProperty && !e.hasOwnProperty(h)) ||
                                    ((v += h + ': '), o(e[h], e), b <
                                        g.length - 1 && (v += ', '));
                            }
                            f--, (v += '}'), p.pop();
                ...
                (t.getDate = o), (t.isNumber = n), (t.isString = l), (t.isArray = i), (t.isBoolean = r), (t.isUndefined = a), (t.isNull = c), (t.isSymbol = s), (t.isObject = d), (t.isFunction = u), (t.isElement = v), (t.htmlEncode = f), (t.JSONStringify = p), (t.getObjAllKeys = g), (t.getObjName = b), (t.setStorage = h), (t.getStorage = m);
            },
            function(e, t, o) {
                'use strict';
                function n(e) {
                ...
                }), (a.render = r['default']), (t['default'] = a), (e.exports =
                    t['default']);
            },
            function(e, t) {
                'use strict';
                function o(e, t, o) {
                    ...
                    for (
                        ...
                        a(e.slice(i, r.index), !1), a(r[1], !0), (i =
                            r.index + r[0].length);
                    a(e.substr(i, e.length - i), !1), (l +=
                        'return arr.join("");'), (l =
                        'with (this) {\n' + l + '\n}');
            ...
            function(e, t, o) {
                    ...
                    if ('top' === e.insertAt)
                        n
                            ? n.nextSibling
                                  ...
                                  : o.appendChild(t)
                            : o.insertBefore(t, o.firstChild), y.push(t);
                    else {
                ...
                function d(e, t, o, n) {
                    ...
                    if (e.styleSheet) e.styleSheet.cssText = _(t, l);
                        ...
                        r[t] && e.removeChild(r[t]), r.length
                            ? e.insertBefore(i, r[t])
                            : e.appendChild(i);
                    }
                }
                function u(e, t) {
                ...
                function v(e, t) {
                    ...
                    var l = new Blob([o], {
                        ...
                        i = e.href;
                    (e.href = URL.createObjectURL(l)), i &&
                ...
                e.exports = function(e, t) {
                    (t = t || {}), 'undefined' == typeof t.singleton &&
                        (t.singleton = g()), 'undefined' == typeof t.insertAt &&
                        (t.insertAt = 'bottom');
                    var o = l(e);
            ...
            function(e, t) {
                ...
                <div class="vc-refresh" ontouchstart="location.reload();"
                style="border: 1px solid rgba(0, 0, 0, 0.2);background: none; color: #000;left: 20px; right: auto;">Refresh</div>
                <div class=vc-switch>Console</div> <div class=vc-mask> </div> <div class=vc-panel> <div class=vc-tabbar> </div> <div class=vc-topbar> </div> <div class=vc-content> </div> <div class=vc-toolbar> <a class="vc-tool vc-global-tool vc-tool-last vc-hide">Hide</a> </div> </div> </div>`;
            },
            function(e, t) {
                e.exports =
                    ...
                    l = (function() {
                        function e(t) {
                            ...
                            o(
                                this,
                                e
                            ), (this.id = t), (this.name = n), (this.eventList = {});
                        }
                        return n(e, [
                            {
                                key: 'on',
            ...
            function(module, exports, __webpack_require__) {
                ...
                (exports['default'] = VConsoleDefaultTab), (module.exports =
                    exports['default']);
            },
            function(e, t, o) {
                'use strict';
                ...
                var c = 'function' == typeof Symbol &&
                    ...
                    x = (function(e) {
                        function t() {
                            ...
                            i(this, t);
                            for (
                                var o = arguments.length, n = Array(o), l = 0;
                                o > l;
                                l++
                            )
                                n[l] = arguments[l];
                            ...
                            return (a.tplTabbox =
                                ''), (a.allowUnformattedLog = !0), (a.isReady = !1), (a.isShow = !1), (a.$tabbox = null), (a.console = {}), (a.logList = []), (a.isInBottom = !0), a.mockConsole(), a;
                        }
                        return a(t, e), s(t, [
                            {
                                key: 'onInit',
                                value: function() {
                                    (this.isReady = !0), (this.$tabbox = f[
                                        'default'
                                    ].render(this.tplTabbox, {}));
                                    for (
                                        var e = 0;
                                ...
                                value: function() {
                                    ...
                                    f['default'].bind(t, 'click', function(o) {
                                        ...
                                        f['default'].removeClass(
                                            l,
                                            'vc-log-partly-log'
                                        ), f['default'].removeClass(l, 'vc-log-partly-info'), f['default'].removeClass(l, 'vc-log-partly-warn'), f['default'].removeClass(l, 'vc-log-partly-error'), 'all' == n ? f['default'].removeClass(l, 'vc-log-partly') : (f['default'].addClass(l, 'vc-log-partly'), f['default'].addClass(l, 'vc-log-partly-' + n));
                                    });
                            ...
                            },
                            {
                                key: 'onShow',
                                value: function() {
                                    (this.isShow = !0), 1 == this.isInBottom &&
                                        this.scrollToBottom();
                                }
                            },
                            {
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    ...
                                    window.console
                                        ? ((this.console.log =
                                              window.console.log), (this.console.info =
                                              window.console.info), (this.console.warn =
                                              window.console.warn), (this.console.debug =
                                              window.console.debug), (this.console.error =
                                ...
                                value: function(e) {
                                    ...
                                    if (t.length || e.content) {
                                        ...
                                        if (
                                            ...
                                            return void (e.noOrigin ||
                                                this.printOriginLog(e));
                                        if (
                                            (e.date ||
                                                (e.date = +new Date()), !this
                                                .isReady)
                                        )
                                        ...
                                        u.isObject(e.content) &&
                                            s.appendChild(e.content), f[
                                            'default'
                                        ]
                                            .one('.vc-log', this.$tabbox)
                                            .appendChild(a), this.isInBottom &&
                                            this.scrollToBottom(), e.noOrigin ||
                                            this.printOriginLog(e);
                                    }
                                }
                            },
                ...
                var c = (function() {
                    ...
                    g = (function(e) {
                        function t() {
                            ...
                            return (a.tplTabbox =
                                p['default']), (a.allowUnformattedLog = !1), a;
                        }
                        return a(t, e), c(t, [
                            {
                                key: 'onInit',
                                value: function() {
                                    s(
                                        ...
                                        'onInit',
                                        this
                                    ).call(this), this.printSystemInfo();
                                }
                            },
                            {
                                key: 'printSystemInfo',
                ...
                var c = (function() {
                    ...
                    w = (function(e) {
                        function t() {
                            ...
                            return (a.$tabbox = d['default'].render(
                                b['default'],
                                {}
                            )), (a.$header = null), (a.reqList = {}), (a.domList = {}), (a.isShow = !1), (a.isInBottom = !0), (a._open = void 0), (a._send = void 0), a.mockAjax(), a;
                        }
                        return a(t, e), c(t, [
                            {
                                key: 'onRenderTab',
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    window.XMLHttpRequest &&
                                        ((window.XMLHttpRequest.prototype.open = this._open), (window.XMLHttpRequest.prototype.send = this._send), (this._open = void 0), (this._send = void 0));
                                }
                            },
                            {
                                key: 'onShow',
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    ...
                                    for (var e in this.domList)
                                        this.domList[e].remove(), (this.domList[
                                            e
                                        ] = void 0);
                            ...
                            },
                            {
                                ...
                                value: function(e, t) {
                                    ...
                                    n.status >= 400 &&
                                        ...
                                        : d['default']
                                              .one('.vc-log', this.$tabbox)
                                              .appendChild(r), (this.domList[
                                        e
                                    ] = r);
                                    var c = Object.keys(this.reqList).length;
                                    c != o && this.renderHeader(), this
                                        .isInBottom && this.scrollToBottom();
                                }
                            },
                            {
                                key: 'mockAjax',
                                            ...
                                            return (e.onreadystatechange = function() {
                                                ...
                                                if (
                                                    ...
                                                    3 == e.readyState ||
                                                        (4 == e.readyState &&
                                                            ((o.status =
                                                                e.status), (o.endTime = +new Date()), (o.costTime =
                                                                o.endTime -
                                                                (o.startTime ||
                                                                    o.endTime)), (o.response =
                                                                e.response)));
